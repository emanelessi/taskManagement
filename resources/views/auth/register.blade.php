    ...
    <h6 class="text-2xl font-bold text-center mb-6 text-text ">
       ...
       <form  class="space-y-4" method="POST" action="{{ route('register') }}">
            ...
            <div class="flex items-center justify-between mt-4">
                <a class="underline text-sm text-text hover:text-hover  rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500  " href="{{ route('login') }}">
           ...
           <div class="flex flex-col  items-center">
               <h6 class="text-2xl font-bold text-center mb-6 text-text  ">or</h6>
               <div class="flex flex-col w-full max-w-xs gap-y-5">
                   <button class="bg-white flex items-center text-gray-700  justify-center gap-x-3 text-sm sm:text-base    rounded-lg hover:bg-gray-100 duration-300 transition-colors border px-8 py-2.5">
                   ...
                   <button class="bg-tertiary flex gap-x-3 text-sm sm:text-base items-center justify-center text-text rounded-lg hover:bg-tertiary/80 duration-300 transition-colors border border-transparent px-8 py-2.5">
                       <svg class="w-5 h-5 sm:h-6 sm:w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                   ...
                   <button class="bg-[black] rounded-lg text-sm sm:text-base flex items-center gap-x-3 justify-center text-text hover:bg-[black]/80 duration-300 transition-colors border border-transparent px-8 py-2.5">
                       <svg class="w-5 h-5 sm:h-6 sm:w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
