    ...
    <h6 class="text-2xl font-bold text-center mb-6 text-gray-700 dark:text-gray-300">
       ...
       <form  class="space-y-4" method="POST" action="{{ route('register') }}">
           ...
           <div class="flex flex-col  items-center">
               <h6 class="text-2xl font-bold text-center mb-6 text-gray-700 dark:text-gray-300">or</h6>
               <div class="flex flex-col w-full max-w-xs gap-y-5">
                   ...
                   <button class="bg-tertiary flex gap-x-3 text-sm sm:text-base items-center justify-center text-white rounded-lg hover:bg-tertiary/80 duration-300 transition-colors border border-transparent px-8 py-2.5">
                       <svg class="w-5 h-5 sm:h-6 sm:w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
