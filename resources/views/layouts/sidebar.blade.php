    ...
    <nav x-data="{ open: false, activeTab: '{{ Route::currentRouteName() }}' }" class="m-2">
        <ul>
            ...
            <li class="flex flex-col items-start py-2 mt-4" x-data="{ open: false }">
                ...
                <div class="px-8 mx-2" x-show="open" x-transition>
                    <div class="text-sm text-gray-600 my-3">
                        <a href="{{ route('categories') }}" class="hover:text-tertiary font-medium">Categories</a>
                    </div>
                    <div class="text-sm text-gray-600 my-3">
            ...
            <li class="flex flex-col items-start py-2 mt-4" x-data="{ open: false }">
                ...
                <div class="px-8 mx-2" x-show="open" x-transition>
                    <div class="text-sm text-gray-600 my-3">
                        <a href="{{ route('project.report') }}" class="hover:text-tertiary font-medium">Project Report</a>
                    </div>
                    <div class="text-sm text-gray-600 my-3">
                        <a href="{{ route('task.report') }}" class="hover:text-tertiary font-medium">Task Report</a>
                    </div>
                </div>
            </li>
