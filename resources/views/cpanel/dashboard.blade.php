        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-6 gap-6">
            <div class="p-4 md:my-4 bg-secondary  rounded-lg shadow ">
                <div class="flex w-full justify-between items-center my-3">
                    ...
                    <h2 class="text-xl text-text">Task Completed</h2>
                ...
                <div class="flex w-full justify-between items-center my-3">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-white">from last week</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 md:my-4 bg-secondary rounded-lg shadow ">
                <div class="flex w-full justify-between items-center my-3">
                    ...
                    <h2 class="text-xl text-text">New Task</h2>
            ...
            <div class="p-4 md:my-4 bg-secondary rounded-lg shadow ">
                <div class="flex w-full justify-between items-center my-3">
                    ...
                    <h2 class="text-xl text-text">Project Done</h2>
