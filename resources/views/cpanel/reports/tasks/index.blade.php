<x-app-layout>
    <div class="container mx-auto py-8">
        ...
        <form action="{{ route('task.pdf') }}" method="POST" class="bg-component shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="md:grid-cols-2 grid md:gap-4 ">
                ...
                <div class="mb-4">
                    <label for="completed_at" class="block text-text text-sm font-bold mb-2">
                        {{ __('Completed Date') }}:
                    </label>
            ...
            <div class="md:grid-cols-2 grid md:gap-4 ">
                <div class="mb-4">
                    <label for="priority" class="block text-text text-sm font-bold mb-2">
                        {{ __('Priority') }}:
                    </label>
                ...
                <div class="mb-4">
                    <label for="category_id" class="block text-text text-sm font-bold mb-2">
                        {{ __('Category') }}:
                    </label>
